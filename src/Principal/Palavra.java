...
public class Palavra {
	...
	Integer pontosDeClassificação, quantiDadeSilabas, quantidaDeLetras;
	...
	public Integer getPontosDeClassificação() {
		return pontosDeClassificação;
	}

	public void setPontosDeClassificação(Integer pontosDeClassificação) {
		this.pontosDeClassificação = pontosDeClassificação;
	}
